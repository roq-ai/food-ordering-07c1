  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Food Ordering: A seamless platform where you can effortlessly order your favorite meals, and administrators can manage orders with ease. It's more than just food, it's a lifestyle."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1529003600303-bd51f39627fb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmb29kJTIwb3JkZXJ8ZW58MHx8fHwxNjk2NDk2NzM1fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@_danbrad?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Daniel Bradley`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Food Ordering: A seamless platform where you can effortlessly order your favorite meals, and administrators can manage orders with ease. It's more than just food, it's a lifestyle.`}
            </Text>
            <Box
